...
/**
 * Domain event published when a user is promoted to a higher league tier
 * at the end of the weekly cycle.
 */
@Getter
public class LeaguePromotionEvent extends ApplicationEvent {
    ...
    public LeaguePromotionEvent(Object source,
                                UUID userId,
