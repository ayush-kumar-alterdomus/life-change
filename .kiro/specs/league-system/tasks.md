...
- [x] 1. Create League DTOs and enums
  - [x] 1.1 Create league data models
...
- [x] 2. Implement League Service
  - [x] 2.1 Create LeagueService
  ...
  - [x] 2.2 Create MatchmakingService
...
- [ ] 3. Implement Weekly League Cycle
  ...
  - [x] 3.2 Create XP event listener for leaderboard updates
...
- [x] 4. Implement Anti-Cheat Detection
  - [x] 4.1 Create AntiCheatService
