...
- [ ] 1. Create Quest DTOs and validation
  - [ ] 1.1 Create quest request/response DTOs
...
- [ ] 2. Implement Quest Service
  - [ ] 2.1 Create QuestService for quest retrieval
...
- [ ] 3. Implement Quest Completion flow
  - [ ] 3.1 Create QuestCompletionService
  ...
  - [ ] 3.2 Create QuestCompletedEvent
...
- [ ] 4. Implement Custom Quest creation
  - [ ] 4.1 Create custom quest endpoint
  ...
  - [ ] 4.2 Add quest limits for free users
...
- [ ] 5. Implement Daily Reset Scheduler
  - [ ] 5.1 Create QuestResetScheduler
  ...
  - [ ] 5.2 Create daily quest assignment logic
