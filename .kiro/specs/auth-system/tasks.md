...
- [ ] 1. Configure Firebase Admin SDK
  - [ ] 1.1 Add Firebase Admin SDK dependency and initialization
  ...
  - [ ] 1.2 Create Firebase token verification service
...
- [ ] 2. Implement JWT security filter
  - [ ] 2.1 Create Firebase JWT authentication filter
...
- [ ] 4. Implement RBAC
  - [ ] 4.1 Create role enum and role-based access
  ...
  - [ ] 4.2 Implement role checking in security context
...
- [ ] 5. Implement rate limiting
  - [ ] 5.1 Create rate limiting infrastructure
