...
- [x] 1. Create Notification data models
  - [x] 1.1 Create DTOs and enums
    ...
    - Add `fcm_token` and `notification_preferences` (JSONB) columns to users table (migration `V28__add_notification_fields.sql`)

- [x] 2. Implement FCM Service
  - [x] 2.1 Create FcmService
...
- [x] 3. Implement Notification Service
  - [x] 3.1 Create NotificationService with daily cap
...
- [x] 4. Implement Streak Alert Logic
  - [x] 4.1 Create StreakAlertScheduler
...
- [x] 5. Create Notification Event Listeners
  - [x] 5.1 Create event-driven notifications
...
- [x] 6. Create Notification Controller
