...
- [ ] 1. Create AI Coach data models
  - [ ] 1.1 Create tables and DTOs
    - Create `V26__create_ai_coach_tables.sql`:
...
- [ ] 2. Implement Burnout Detection
  - [ ] 2.1 Create BurnoutDetectionService
...
- [ ] 3. Implement Adaptive Difficulty
  - [ ] 3.1 Create AdaptiveDifficultyService
...
- [ ] 5. Create AI Coach Scheduler
  - [ ] 5.1 Create daily evaluation scheduler
...
- [ ] 6. Create AI Coach Controller
  - [ ] 6.1 Implement REST endpoints (premium-gated)
...
- [ ] 7. Write property-based tests
  - [ ] 7.1 Create AI coach property tests
