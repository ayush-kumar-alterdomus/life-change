...
- [x] 1. Create Stats DTOs and constants
  - [x] 1.1 Create stat data models
...
- [ ] 2. Implement Stat Service
  ...
  - [x] 2.2 Create title unlock logic
...
- [x] 4. Implement Life Score calculation
  - [x] 4.1 Create LifeScoreCalculator
